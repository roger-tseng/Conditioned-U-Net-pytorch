...
class Conditional_Source_Separation(pl.LightningModule, metaclass=ABCMeta):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('loss/train_loss', loss, prog_bar=False, logger=True, on_step=False, on_epoch=True,
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('loss/val_loss', loss, prog_bar=False, logger=True, on_step=False, on_epoch=True,
                   reduce_fx=torch.mean)
        return loss
